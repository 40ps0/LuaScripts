...
maze2:addButton("Secret Door ESP", function()
    for i,v in pairs(game.Workspace:FindFirstChild("Door")) do
        ...
        BillboardGui.Size = UDim2.new(0, 100, 0, 100) -- size of it
        BillboardGui.StudsOffset = Vector3.new(0,2,0)
        
        TextLabel.Parent = BillboardGui -- putting textlabel into billboardgui
        TextLabel.BackgroundColor3 = Color3.new(244,244,244) -- color
        TextLabel.BackgroundTransparency = 0.6 -- transparency
        TextLabel.Size = UDim2.new(1, 0, 1, 0) -- size
        TextLabel.Text = "Secret Door" -- what the label says
        TextLabel.TextColor3 = Color3.new(15, 15, 15) -- color
...
section1:addButton("Door ESP", function()
    for i,v in pairs(game.Workspace:GetDescendants()) do
        ...
        TextLabel.Parent = BillboardGui -- putting textlabel into billboardgui
        TextLabel.BackgroundColor3 = Color3.new(0.294117, 0.286274, 0.286274) -- color
        TextLabel.BackgroundTransparency = 0.6 -- transparency
        TextLabel.Size = UDim2.new(1, 0, 1, 0) -- size
        TextLabel.Text = "Door" -- what the label says
        TextLabel.TextColor3 = Color3.new(45, 45, 45) -- color
        TextLabel.TextScaled = true -- if the text is scaled or not
        TextLabel.Font = "Gotham"
    end
    end
